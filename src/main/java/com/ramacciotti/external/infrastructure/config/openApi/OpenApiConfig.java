package com.ramacciotti.external.infrastructure.config.openApi;
...
public class OpenApiConfig {
    ...
    private List<Tag> tags() {
        ...
        Tag userController = new Tag();
        userController.setName("User Controller");

        return List.of(userController);
